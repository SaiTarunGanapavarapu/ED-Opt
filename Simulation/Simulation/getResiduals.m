...
function res = getResiduals(voltCellPairCal, mode, flowConcIn, flowDilIn, j)
    ...
    voltTotalDesired    = params.voltTotal(j) ; 
    currDesired         = params.curr     (j) ;
    currDensDesired     = params.currDens (j) ;
