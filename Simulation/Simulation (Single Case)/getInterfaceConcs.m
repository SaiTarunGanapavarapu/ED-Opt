...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [concConcIntCEM, concConcIntAEM, concDilIntCEM, concDilIntAEM, iLim] = getInterfaceConcs(concConc, concDil, flowConc, flowDil, currDens)
    ...
    [~, ~, ~, ~, ShConcCEM, ShConcAEM, ShDilCEM, ShDilAEM] = getDimLessNumbers(flowConc, flowDil);
