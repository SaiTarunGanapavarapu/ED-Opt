...
function [RHS] = getModelEqsRHS(z, stateVar, diffVar, algVar)
    ...
    [concConcIntCEM, concConcIntAEM, concDilIntCEM, concDilIntAEM, ~] = getInterfaceConcs(concConc, concDil, flowConc, flowDil, currDens);
    ...
    [resistTotal, nonOhm] = getResistances(concConc, concDil, concConcIntCEM, concConcIntAEM, concDilIntCEM, concDilIntAEM);
